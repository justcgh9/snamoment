...
from Core.moviepy.audio.AudioClip import CompositeAudioClip
from Core.moviepy.tools import deprecated_version_of
from Core.moviepy.video.compositing.CompositeVideoClip import CompositeVideoClip
from Core.moviepy.video.VideoClip import ColorClip, VideoClip
