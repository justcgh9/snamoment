...
from Core.moviepy.video.io.ffmpeg_reader import FFMPEGVideoReader
from Core.moviepy.video.VideoClip import VideoClip
...
class VideoFileClip(VideoClip):
    ...
    you must call close() afterwards, or the subresources will not be cleaned up until
    the process ends.
    ...
    def __init__(self, filename, has_mask=False,
        ...
        self.reader = FFMPEGVideoReader(filename, pix_fmt=pix_fmt,
